...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img class="w-64" src="{{ $actor['profile_path']}}" alt="poster" class="hover:opacity-75 transition ease-in-out duration-150">
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    <span class="ml-2">{{ $actor['birthday']}} ({{$actor['age']}} year old) in  {{$actor['place_of_birth']}} </span>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                    @foreach ($knownForMovies as $movie)
                        <div class="mt-4">
                            ...
                            <a href="{{$movie['linkToPage']}}" class="text-sm loading-normal block text-gray-400 hover:text-white mt-1">
                                {{ $movie['title']}}
                            </a>
                        </div>
                    @endforeach
